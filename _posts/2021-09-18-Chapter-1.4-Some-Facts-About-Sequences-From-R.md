...
Here is Kwan's strategy, given (by Sal) a convergent sequence, \\( (a_n)\to a \\), he will respond with \\( r=\text{max}\\{d(a,a_1),\ldots,d(a,a_{N-1})\\}+1 \\). This number \\( r \\) is engineered to satisfy both
