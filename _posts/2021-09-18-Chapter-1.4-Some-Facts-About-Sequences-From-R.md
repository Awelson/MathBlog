...
Notice that the sequence Kwan presented as evidence does not contain \\( x \\) at all, i.e, \\( a_n\neq x \\) for all \\( n \\) [this is because \\( x\notin A \\)]. This is not important right now, but will be at some later point.
