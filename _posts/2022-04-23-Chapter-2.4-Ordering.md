...
Proof. 1. \\( \ \gamma : m,n,p: \omega \\). \\( \gamma \vdash m\in n \ \rightarrow \ m+p\in n+p \\)

| O           |       P     |
| :-----------: | :-----------: |
|               | 1. \\( \ m+p=n+p \ \rightarrow \ m=n \\)|
| 2. \\( m+p=n+p \\) (C1) | .        |
| 4. admit(3)             | 3. Fact: \\( \ m\in n \ \lor \ m=n \ \lor n\in m \\) |
| 6. \\( m\in n \\)  (D4) | 5. \\( \lor? \\) (C4)  |
| 8. admit(7)     | 7. Fact: \\( m\in n \ \rightarrow \ m+p\in n+p \\)   |
| 10. \\( m+p\in n+p \\) (D8)      | 9. \\( m\in n \\) (C8) |                                    
| 12. Concede                      | 11. Contradiction(2,10) |
