...
**Example.** Consider \\( \mathbb{R}^2 \\), we are also familiar with a method of measuring distances between the points of this set. Via pythagoras, derive a metric \\( d:\mathbb{R}^2\times \mathbb{R}^2\to \mathbb{R} \\), where \\( d(x,y)=\sqrt{\|x_1-x_2\|^2+\|y_1-y_2\|^2} \\) with \\( x=(x_1,x_2) \\) and \\( y=(y_1,y_2) \\).
