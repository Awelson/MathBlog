...
is not defined, we can just agree that the above equals \\( \bigcup A \\) which is defined (by our axioms). Anyways the concept of infinity is still way out of reach right now so lets not dwell on this further.
