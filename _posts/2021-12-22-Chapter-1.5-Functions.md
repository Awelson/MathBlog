...
\\[ \begin{align\*} z\in (F\circ G)[A] \quad &\Longleftrightarrow \exists x\in A, \ <x,z>\in F\circ G \newline &\Longleftrightarrow \exists x\in A, \ \exists y, \ xGy \ \land yFz \newline &\Longleftrightarrow \exists y\in G[A], \ yFz \newline &\Longleftrightarrow y\in F[G[A]] \quad \Box \end{align\*} \\]
